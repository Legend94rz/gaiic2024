...
class CoDETR(BaseDetector):
    ...
    def forward(self, mode, **data):
        ...
        if mode == 'loss':
            ...
            return self.predict(inputs, data_samples, **data)
        elif mode == 'tensor':
            return self._forward(inputs, data_samples, **data)
        else:
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        if self.with_query_head:
            bbox_losses, x = self.query_head.loss(x, batch_data_samples, tir_feature)
